@echo off
REM EF Core Migration Script for Trip.Infrastructure
...
set INFRASTRUCTURE_PROJECT=Trip.Infrastructure.csproj
set STARTUP_PROJECT=..\Trip.API\Trip.API.csproj
set CONTEXT=TripDbContext
